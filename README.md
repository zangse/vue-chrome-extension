## 商店截图
![image](https://github.com/zangse/vue-chrome-extension/blob/master/screenshots/chrome-extension_2019-1-3.png)
### 截止2019年1月3日 书签管理用户数 1500+，扩展管理用户数2300+
## chrome 扩展文档
...
-   配置扩展展示方式，小图标形式，用户可以自定义设置（2019-1-3）
